package com.example.androidirregularverbs;
...
public class MainActivity extends Activity {
	...
	String[] verbArr =  {"to abide, abode (abided), abode (abided) - дотримуватися",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//int i = verbArr.length;
		String length = String.valueOf(verbArr.length) + " дієслів завантажено.";
